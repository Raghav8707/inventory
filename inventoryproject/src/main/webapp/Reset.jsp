...
 
 User Name<input name="userName" value="${param.name}" class="form-control" type="text"  /> <br/><br/>

 Enter Password 
<input type="password" name="password" class="form-control" pattern="/^[a-zA-Z0-9!@#\$%\^\&*_=+-]{8,12}$/g" id="pswd1"> <br/><br/>

 Confirm Password
<input type="password" name="passcode" class="form-control" pattern="/^[a-zA-Z0-9!@#\$%\^\&*_=+-]{8,12}$/g" id = "pswd2" > <br/><br/>
