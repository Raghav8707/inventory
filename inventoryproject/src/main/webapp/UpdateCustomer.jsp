...
<jsp:useBean id="dao" class="com.Infinite.inventoryproject.CustomerDAO"></jsp:useBean>
	...
	<div class="align-items-center" style="width: 400px;display:flex;align-items:center;justify-content:center">
		<form action="UpdateCustomer.jsp">
			...
			<input name="customerName" style="width:70%" class="form-control" type="text" pattern="[A-Za-z]{1,15}" value="${customers.customerName }">
			</div>
			<div  class="mb-3 formI">
			<label style="width:27%">Customer Phone Number:</label>
			<input name="customerPhoneNo" style="width:70%" class="form-control" type="number" value="${customers.customerPhoneNo }" >
			</div>
			<div class="mb-3 formI">
			<label style="width:27%">address1:</label>
			<input name="address1" style="width:70%" class="form-control" type="text" value="${customers.address1}" >
			</div>
			<div  class="mb-3 formI">
			<label style="width:27%">address2:</label>
			<input name="address2" style="width:70%" class="form-control" type="text" value="${customers.address2}" >
			</div>
			<div  class="mb-3 formI">
			 <label style="width:27%">Pincode:</label>
			<input name="zipcode" style="width:70%" class="form-control" type="number" value="${customers.zipcode}" >
			</div>
			<div  class="mb-3 formI">
			...
			<input name="passCode" style="width:70%" class="form-control" type="password" pattern="/^[a-zA-Z0-9!@#\$%\^\&*_=+-]{8,12}$/g" 
			value="${customers.passCode }" >
			</div>
			<div class="mb-3 formI">
			 <label style="width:27%">city:</label>
			<input name="city" style="width:70%" class="form-control" type="text"  pattern="[A-Za-z]{1,15}"  value="${customers.city}">
			</div>
